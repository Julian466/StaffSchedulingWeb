...
import { FetchParams, SolverJob } from '@/types/solver';
import { randomUUID } from 'crypto';

const apiLogger = createApiLogger('/api/solver/fetch');

/**
 * POST /api/solver/fetch
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      {
        error: 'Failed to execute fetch command',
