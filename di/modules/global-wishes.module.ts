...
export function createGlobalWishesModule() {
    ...
    m.bind(DI_SYMBOLS.IImportGlobalWishesTemplateController).toHigherOrderFunction(makeImportGlobalWishesTemplateController, [DI_SYMBOLS.IImportGlobalWishesTemplateUseCase]);
