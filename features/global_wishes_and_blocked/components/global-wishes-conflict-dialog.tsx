            ...
            <DialogContent>
                <DialogHeader className="pr-12">
                    ...
                    <DialogDescription className="whitespace-normal wrap-break-word">
                        Für <strong>{employeeName}</strong> sind bereits monatliche Wünsche vorhanden. Wie möchtest du
                        fortfahren?
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="mt-4 space-y-3">
                    <div className="text-sm">
                        ...
                        <div className="text-muted-foreground">Monatliche Wünsche für diesen Mitarbeiter werden entfernt
                            und durch die globalen Wünsche ersetzt.
                        </div>
                    </div>

                    <div className="text-sm">
                        <strong>2) Monatliche Wünsche beibehalten und global ignorieren</strong>
                        <div className="text-muted-foreground">Die globalen Änderungen werden gespeichert, werden aber
                            für den aktuellen Monat nicht in die Monatsdaten übernommen.
                        </div>
                    </div>
                ...
                <DialogFooter className="pt-4 flex-wrap sm:flex-nowrap justify-center gap-2">
                    <Button variant="destructive" size="sm" className="min-w-0 whitespace-normal" onClick={() => {
                        onChoice('overwrite');
                        onOpenChange(false);
                    }}>
                        <Check className="mr-2 h-4 w-4"/> Überschreiben
                    </Button>
                    <Button variant="outline" size="sm" className="min-w-0 whitespace-normal" onClick={() => {
                        onChoice('keep-monthly');
                        onOpenChange(false);
                    }}>
