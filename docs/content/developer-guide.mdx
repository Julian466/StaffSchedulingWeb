...
<figure>
    ![Clean Architecture Diagramm](https://raw.githubusercontent.com/nikolovlazar/nextjs-clean-architecture/main/assets/clean-architecture-diagram.jpg)

    <figcaption style={{ textAlign: 'center', fontSize: '0.9em', color: 'gray', marginTop: '10px' }}>
        Abbildung 1: Clean Architecture in Next.js. Quelle: Lazar Nikolov (2024), [GitHub Repository](https://github.com/nikolovlazar/nextjs-clean-architecture).
    </figcaption>
</figure>
